                        ...
                        <div class="card">
                            ...
                            <div class="row mb-3">
                                ...
                                <form action="{{ url('pinjaman/'.$data->noVak) }}" method="POST">
                                    ...
                                    <div class="col-sm-4">: {{ $data->noVak }}</div>
                                    <h6 class="col-sm-2">Luas Baku</h6>
                                    <div class="col-sm-4">: {{ $data->luasBaku }}</div>
                                    <h6 class="col-sm-2">No. Kontrak</h6>
                                    <div class="col-sm-4">: {{ $data->noKontrak }}</div>
                                    <h6 class="col-sm-2">Kategori</h6>
                                    <div class="col-sm-4">: {{ $data->kategori }}</div>
                                    <h6 class="col-sm-2">Periode</h6>
                                    <div class="col-sm-4">: {{ $data->periode }}</div>
                                    </div>
                                </form>
                            </div>
